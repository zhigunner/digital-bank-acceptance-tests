Feature: Transfer between accounts
  ...
  Scenario: Transfer between existing accounts with the negative amount
    ...
    And the user firstly selects the "Regular Checking (Standard Checking)" account then selects "Family Checking (Standard Checking)" account and transfers "-100" dollars
